...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: ZYuj0xZwcT0zEB/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__lY35E, {
          [sty.box__long__lY35EfTg0Z]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__rqEs, {
            [sty.box__long__rqEsFTg0Z]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg___1OppY)}
                role={"img"}
              />
            ),
