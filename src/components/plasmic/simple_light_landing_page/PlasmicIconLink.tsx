...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: x1taA3sWDL3Yn/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__pVo3H)}
              role={"img"}
            />
          ),
