...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: lnAB4A8AW5IT3/css

import heroImageDeXb23VkAyPcWn from "./images/heroImage.png"; // plasmic-import: deXb23VkAyPcWN/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___1AWyK)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__xNfSk)}
        >
          <div className={classNames(defaultcss.all, sty.box__mvgF)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__eey69)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__fMjTp)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton___8Yv9Y)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__xq3E8)}>
          <img
