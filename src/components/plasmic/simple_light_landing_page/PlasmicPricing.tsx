...
import Plan from "../../Plan"; // plasmic-import: hSOL-3dbgsN9Of/component
import Bullet from "../../Bullet"; // plasmic-import: HWz2MLfMJ4m9tS/component
import LinkButton from "../../LinkButton"; // plasmic-import: zegKQfeUyGxsG/component
import Faq from "../../Faq"; // plasmic-import: YVsSe6GvgDBttL/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: KDNvXQfjRclVi-/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__kjn7E)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__dqwHp)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.box__mIvCf)}
                  >
                    <Plan
                      className={classNames("__wab_instance", sty.plan__mic6J)}
                      price={
                        <div
                          className={classNames(
                            defaultcss.all,
                    ...
                    <Plan
                      className={classNames("__wab_instance", sty.plan__kIhB)}
                      description={
                        <p.Stack
                          as={"div"}
                          hasGap={true}
                          className={classNames(defaultcss.all, sty.box__sn98I)}
                        >
                          <Bullet
                            className={classNames(
                              "__wab_instance",
                    ...
                    <Plan
                      className={classNames("__wab_instance", sty.plan__oYqb)}
                      name={"Enterprise"}
                      price={
                        <div
                          className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section__bhgNu)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__f2Jub)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__gLfd8)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__eCig)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
