...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: YVsSe6GvgDBttL/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___8ZUry)}
      >
        <div className={classNames(defaultcss.all, sty.box__tSYgo)}>
          <div className={classNames(defaultcss.all, sty.box___4E9Hd)}>
            {p.renderPlasmicSlot({
