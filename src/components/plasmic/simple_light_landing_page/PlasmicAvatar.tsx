...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: 4Sw5feT-BbHQlI/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__vUwv0)}
            role={"img"}
