...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: yla-VFAPoaF73a/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: 5fMdNEXcvBVkNB/icon
import profilepic0DmEt1ArQ9CPv0 from "./images/profilepic.png"; // plasmic-import: 0dmEt1arQ9CPv0/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__w4BGc)}
      >
        <div
