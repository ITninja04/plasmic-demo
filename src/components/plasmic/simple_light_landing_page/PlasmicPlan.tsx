...
import BaseCard from "../../BaseCard"; // plasmic-import: ZYuj0xZwcT0zEB/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: hSOL-3dbgsN9Of/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box___5DIs)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__zSnZm)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__kpgW6)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__v852W)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___5IkwI)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__pqXkh)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box___7XCfy)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
